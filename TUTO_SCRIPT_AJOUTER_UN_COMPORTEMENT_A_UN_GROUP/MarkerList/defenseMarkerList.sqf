...
_posDefense = getmarkerpos(_markerList select 0);

{
	_posDefense = getmarkerpos _x;
	_wp = _crew addWaypoint[_posDefense, 0];
...
_wpMovePC = _crew addWaypoint[_posDefense, 0];
...
_wpUnloadPC = _crew addWaypoint[_posDefense, 0];
_wpUnloadPC setWaypointType "UNLOAD";

_wpSadPC = _crew addWaypoint[_posDefense, 0];
_wpSadPC setWaypointType "SAD";

_wpGuardPC = _crew addWaypoint[_posDefense, 0];
_wpGuardPC setWaypointType "SENTRY";
